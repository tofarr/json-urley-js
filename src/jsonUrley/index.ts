...
export type JsonType =
  ...
  | JsonType[]
  | { [key: string]: JsonType };
export type JsonObjType = { [key: string]: JsonType };
...
function appendParamToObj(pathElement: PathElement, parent: JsonObjType) {
...
function generateQueryParams(
  ...
  if (jsonObj == null) {
    ...
    for (let key in jsonObj as JsonObjType) {
...
function generateQueryParamsForList(
  jsonObj: JsonType[],
  currentParam: string[],
  isNestedList: boolean,
  target: URLSearchParams,
...
function generateQueryParamsForStr(
  jsonObj: string,
  currentParam: string[],
  target: URLSearchParams,
) {
